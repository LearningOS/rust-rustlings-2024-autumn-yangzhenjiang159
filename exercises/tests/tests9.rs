...
mod foo {
    ...
    #[no_mangle] // Prevent name mangling for this function
    pub fn my_demo_function(a: u32) -> u32 { // Make it public so it's accessible
        a
    }

    #[no_mangle]
    pub fn my_demo_function_alias(a: u32) -> u32 { // Make it public too
